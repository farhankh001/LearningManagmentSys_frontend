...
function MCQQuizAttemptFrom({ questions, title }: MCQQuizAttemptFormProps) {
  ...
  return (
    <Box sx={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", gap: 2, justifyContent: "center", m: 3 }}>

      <Box sx={{ width: "1300px", display: "flex", gap: 1.5 }}>
        <Box sx={{
          ...
          <Typography sx={{ display: 'flex', alignItems: "center", justifyContent: 'center', gap: 2, mb: 3, }} variant="h5" fontWeight={600}><span>Quiz {title}</span> <Insights sx={{ color: theme.palette.warning.light }} /></Typography>
          {questions && (
        ...
        <Box sx={{ width: "20%", height: "255px", display: "flex" }}>

import { alpha, Box, Card, CardMedia, SvgIconTypeMap, Typography, useTheme } from '@mui/material'
    ...
    <Box sx={{
      ...
      {courses && courses.map(course => {
        ...
        return <Card component={Link} to={`/single-course-details/${course.id}`} sx={{
          ...
          textDecoration: 'none',
          backgroundColor: alpha(categoryBackgroundMap[course.course_categories[0]?.category.title], 0.3) || categoryBackgroundMap['Default'],
          border: "0.5px solid",
